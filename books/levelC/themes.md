...
This level introduces introduces dialogue and 1st/2nd person verb forms.
Stories should be 50% dialogue 50% narration. The narration should explain movements and actions that would be unnatural to explain in the dialogue.
...
There is minimal new vocabulary introduced since there are many new grammar forms being introduced.

Basic expressions:
- χαῖρε / χαίρετε (hello, greetings)
- ἔρρωσο / ἔρρωσθε (farewell, goodbye)
- εὐχαριστῶ (thank you)
...
- (prefer using the enclitic versions of the pronouns)
